...
{
    public partial class UcReturnBackStopFlights : UserControl
    {
        private int m_panelHeight;
        private bool m_toggleStatus;
        public UcReturnBackStopFlights()
        {
            InitializeComponent();
            // animation
        ...
        private void UcReturnBackStopFlights_Click(object sender, EventArgs e)
        {
            tmrAnimation.Start();
        }
    }
