...
namespace HassilBook
{
    public class Flight
    {
        ...
        public List<FlightModel> EconomySearch(string from, string to, string dep)
        {
        ...
        public List<FlightModel> BusinessSearch(string from, string to, string dep)
        {
            List<FlightModel> flightModel = new List<FlightModel>();
            try
            {
